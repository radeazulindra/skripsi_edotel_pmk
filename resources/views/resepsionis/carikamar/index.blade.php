    ...
    function buatSelector(){
        ...
        if (dateFrom != '' && dateTo != '' && dateTo > dateFrom) {
            ...
            for (let i = 0; i < window.listKamar.length; i++) {
                ...
                var setHTML = '<input id="room-'+idKamar+'" class="room-select" '+statusKamar+' type="checkbox" value="'+idKamar+'" name="room[]" /><label for="room-'+idKamar+'" class="room '+isOccupied+'">'+noKamar+'<br>'+tipeKamar+' Room</label>';
